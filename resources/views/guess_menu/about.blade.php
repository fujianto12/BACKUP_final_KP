...
@section('content')
     ...
     <!-- About Start -->
     <div class="about wow fadeInUp mt-5" data-wow-delay="0.1s">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="section-header text-left">
                        <p>Selamat datang di PT Lematang</p>
                        <h2>39 Tahun Pengalaman</h2>
                    </div>
